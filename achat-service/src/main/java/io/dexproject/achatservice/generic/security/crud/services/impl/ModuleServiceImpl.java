...
public class ModuleServiceImpl extends ServiceGenericImpl<ModuleRequest, ModuleReponse, Module> implements ModuleService {
    public ModuleServiceImpl(JpaEntityInformation<Module, Long> entityInformation, GenericRepository<Module> repository, GenericMapper<ModuleRequest, ModuleReponse, Module> mapper) {
